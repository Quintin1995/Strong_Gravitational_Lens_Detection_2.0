...
def load_chunk(chunksize, X_lenses, X_negatives, X_sources, data_type, mock_lens_alpha_scaling):
    ...
    X_pos, y_pos = merge_lenses_and_sources(X_lenses, X_sources, num_positive, data_type, mock_lens_alpha_scaling)
...
def split_train_test_data(data_array, label, test_fraction=0.2):
...
def merge_lenses_and_sources(lenses_array, sources_array, num_mock_lenses, data_type, mock_lens_alpha_scaling = (0.02, 0.30)):
